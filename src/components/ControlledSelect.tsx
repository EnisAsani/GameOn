  ...
  return (
    <Box>
      <Select value={value} onChange={(_, newValue) => setValue(newValue)}>
        <Option value={10}>Most Popular</Option>
        <Option value={20}>Name(Ascending)</Option>
        <Option value={30}>Name(Descending)</Option>
        <Option value={40}>Price(Ascending)</Option>
        <Option value={50}>Price(Descending)</Option>
      </Select>
...
const StyledButton = styled(CustomButton, { shouldForwardProp: () => true })(
  ...
  text-align: left;
  line-height: 1.5;
  background: ${theme.palette.mode === 'dark' ? grey[900] : '#495057'};
  border: 1px solid ${theme.palette.mode === 'dark' ? grey[700] : "#495057"};
  color: ${theme.palette.mode === 'dark' ? grey[300] : "white"};
  box-shadow: 0px 2px 2px ${theme.palette.mode === 'dark' ? grey[900] : "#495057"};
