...
export const GraphicCardProduct = (props: GraphicCardProps) => {
    ...
    padding:"5px", cursor:"pointer"
        ...
        <img loading="lazy" className="graphicImg" style={{objectFit:"cover", borderRadius:"10px", aspectRatio:"16/9"}} width="100%" src={baseImgUrl + props.imgUrl.toLowerCase() || "https://media.istockphoto.com/id/1314343964/photo/top-end-system-unit-for-gaming-computer-close-up.jpg?s=2048x2048&w=is&k=20&c=gz1quan2pGMzCMIYUfzfxCSGgCz0asnPNu0B3rclQTI="}/>
        </div>
